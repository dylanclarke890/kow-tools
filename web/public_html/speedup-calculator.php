    ...
    <form id="form" method="post" action="sessions2.php">
      ...
      <div id="wall" class="card text-center">
        <div id="priority" class="card-header">
          ...
          <ul id="menuButts" class="row nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item col ">
              <a id="trainingFormButton" class="nav-link formButts col col-md active" data-toggle="tab"
                href="#trainingTab">
        ...
        <div id="conDiv" class="tab-content card-body mx-auto">
              ...
              <div class="tweak">
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="60" class="trainingInput form-control" type="number" id="trainingIn60" value="0"
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3">
                    <input data-amt="300" class="trainingInput form-control" type="number" id="trainingIn300" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="600" class="trainingInput form-control" type="number" id="trainingIn600" value="0"
                      onclick="if(this.value==0){this.value='';}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="900" class="trainingInput form-control" type="number" id="trainingIn900" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="1800" class="trainingInput form-control" type="number" id="trainingIn1800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="3600" class="trainingInput form-control" type="number" id="trainingIn3600"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="10800" class="trainingInput form-control" type="number" id="trainingIn10800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="28800" class="trainingInput form-control" type="number" id="trainingIn28800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="54000" class="trainingInput form-control" type="number" id="trainingIn54000"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="86400" class="trainingInput form-control" type="number" id="trainingIn86400"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
            ...
            <div id="repairForm" class="container-fluid">
              ...
              <div class="tweak">
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="60" class="repairInput form-control" type="number" id="repairIn60" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="300" class="repairInput form-control" type="number" id="repairIn300" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="600" class="repairInput form-control" type="number" id="repairIn600" value="0"
                      onclick="if(this.value==0){this.value='';}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="900" class="repairInput form-control" type="number" id="repairIn900" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="1800" class="repairInput form-control" type="number" id="repairIn1800" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="3600" class="repairInput form-control" type="number" id="repairIn3600" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="10800" class="repairInput form-control" type="number" id="repairIn10800" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="28800" class="repairInput form-control" type="number" id="repairIn28800" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="54000" class="repairInput form-control" type="number" id="repairIn54000" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="86400" class="repairInput form-control" type="number" id="repairIn86400" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
            ...
            <div id="researchForm" class="container-fluid">
              ...
              <div class="tweak">
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="60" class="researchInput form-control" type="number" id="researchIn60" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="300" class="researchInput form-control" type="number" id="researchIn300" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="600" class="researchInput form-control" type="number" id="researchIn600" value="0"
                      onclick="if(this.value==0){this.value='';}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="900" class="researchInput form-control" type="number" id="researchIn900" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="1800" class="researchInput form-control" type="number" id="researchIn1800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="3600" class="researchInput form-control" type="number" id="researchIn3600"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="10800" class="researchInput form-control" type="number" id="researchIn10800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="28800" class="researchInput form-control" type="number" id="researchIn28800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="54000" class="researchInput form-control" type="number" id="researchIn54000"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="86400" class="researchInput form-control" type="number" id="researchIn86400"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
            ...
            <div id="buildingForm" class="container-fluid">
              ...
              <div class="tweak">
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="60" class="buildingInput form-control" type="number" id="buildingIn60" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="300" class="buildingInput form-control" type="number" id="buildingIn300" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="600" class="buildingInput form-control" type="number" id="buildingIn600" value="0"
                      onclick="if(this.value==0){this.value='';}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="900" class="buildingInput form-control" type="number" id="buildingIn900" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="1800" class="buildingInput form-control" type="number" id="buildingIn1800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="3600" class="buildingInput form-control" type="number" id="buildingIn3600"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="10800" class="buildingInput form-control" type="number" id="buildingIn10800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="28800" class="buildingInput form-control" type="number" id="buildingIn28800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="54000" class="buildingInput form-control" type="number" id="buildingIn54000"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="86400" class="buildingInput form-control" type="number" id="buildingIn86400"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
            ...
            <div id="generalForm" class="container-fluid">
              ...
              <div class="tweak">
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="60" class="generalInput form-control" type="number" id="generalIn60" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="300" class="generalInput form-control" type="number" id="generalIn300" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="600" class="generalInput form-control" type="number" id="generalIn600" value="0"
                      onclick="if(this.value==0){this.value='';}">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="900" class="generalInput form-control" type="number" id="generalIn900" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="1800" class="generalInput form-control" type="number" id="generalIn1800" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="3600" class="generalInput form-control" type="number" id="generalIn3600" value="0"
                      onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="10800" class="generalInput form-control" type="number" id="generalIn10800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="28800" class="generalInput form-control" type="number" id="generalIn28800"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="54000" class="generalInput form-control" type="number" id="generalIn54000"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-4 col-md-3 ">
                    <input data-amt="86400" class="generalInput form-control" type="number" id="generalIn86400"
                      value="0" onclick="if(this.value==0){this.value='';}">
                  </div>
          ...
          <button type="submit" class="signpost mx-auto" id="nextLink"><span
              class="carousel-control-next-icon"></span>Save and continue: Troop Calculator<span
